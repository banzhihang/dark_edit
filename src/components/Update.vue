<template>
  <div>
    <el-form :inline="true" :model="form"  class="head">
      ...
      <el-button type="success" @click="save" size="medium" :loading="isLoading">保存文章</el-button>
    </el-form>
    <div class="edit">
      <mavon-editor
          v-model="content"
...
export default {
  ...
  methods: {
    ...
    async save(){
      ...
      this.isLoading = true
      const {data:res} = await this.$http.put('/article',d)
